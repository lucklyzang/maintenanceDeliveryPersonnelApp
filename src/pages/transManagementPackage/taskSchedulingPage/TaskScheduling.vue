...
<script>
import { mapGetters, mapMutations } from "vuex";if(this.projectGlobalTimer) {window.clearInterval(this.projectGlobalTimer)};
import { userSignOut } from '@/api/login.js'
import store from '@/store'
import { queryDispatchTaskCancelReason,queryTaskDelayReason } from '@/api/trans/workerPort.js'
