...
import {updateCleaningManageTaskState, cleaningManageTaskComplete,reviewTask,fetchTask,returnTask,attendanceAllWorkerList} from "@/api/clean/environmentalManagement.js";
...
export default {
  ...
  computed: {
    ...mapGetters(["userInfo","chooseHospitalArea","cleanTaskDetails","timeMessage","ossMessage","chooseProject","storageSpecialTaskMessage"]),
    userName() {
  ...
  methods: {
    ...
    getRegisterUser() {
      ...
      attendanceAllWorkerList(this.proId)
      .then((res) => {
        this.loadText = '';
