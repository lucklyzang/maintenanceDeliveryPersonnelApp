...
import {getEventDetails} from '@/api/securityPatrol/escortManagement.js'
...
export default {
  ...
  computed: {
    ...mapGetters(["userInfo","chooseHospitalArea","transportantTaskMessage","enterEventRegisterPageMessage","temporaryStorageRepairsRegisterMessage","claimRegisterElectronicSignatureMessage","moreEventMessage"]),
    userName() {
